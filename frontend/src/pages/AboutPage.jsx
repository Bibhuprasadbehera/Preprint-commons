  ...
  return (
    <Layout>
      <div className={styles.pageContainer}>
        ...
        <div className={`${styles.contentSection} animate-fadeInUp animate-delay-6`} style={{
          marginTop: 'var(--spacing-4xl)'
        }}>
          <div style={{
            background: 'var(--color-bg-secondary)',
            ...
            <h2 className="text-heading-2" style={{ marginBottom: 'var(--spacing-xl)' }}>
            </h2>
            <p className="text-body" style={{ 
              maxWidth: '700px',
              ...
              Preprint Commons was developed by <strong style={{ color: 'var(--color-text-primary)' }}>Bibhu Prasad Behera</strong>, 
              who led the data collection, backend development, and frontend development of the platform.
            </p>
